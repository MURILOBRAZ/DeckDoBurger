        ...
        body: Column(
          ...
          children: [
            ...
            Align(
              alignment: AlignmentDirectional(0.0, 0.0),
              child: Padding(
                padding: EdgeInsetsDirectional.fromSTEB(32.0, 60.0, 32.0, 32.0),
                child: Column(
                  mainAxisSize: MainAxisSize.max,
                  mainAxisAlignment: MainAxisAlignment.center,
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Padding(
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) => StreamBuilder<LoginRecord>(
                          stream:
                              LoginRecord.getDocument(currentUserReference!),
                          builder: (context, snapshot) {
                            ...
                            final nameLoginRecord = snapshot.data!;
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<LoginRecord>(
                        stream: LoginRecord.getDocument(currentUserReference!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                          ...
                          final buttonLoginRecord = snapshot.data!;
                              ...
                              if ((_model.passwordTextController.text != '') &&
                                  (_model.passwordTextController.text ==
                                      _model.confirmPasswordTextController
                                          .text)) {
                                await buttonLoginRecord.reference
