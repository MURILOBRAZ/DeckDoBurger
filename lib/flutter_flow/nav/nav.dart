...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CardapioPageWidget.routeName,
          path: CardapioPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'CardapioPage')
              : CardapioPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: CarrinhoPageWidget.routeName,
          path: CarrinhoPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'CarrinhoPage')
              : CarrinhoPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => ItemPageWidget(
            ...
            especificacoes: params.getParam(
              'especificacoes',
              ParamType.String,
            ),
            detalhes: params.getParam(
              'detalhes',
              ParamType.String,
            ),
